  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold mb-6" style={{ fontFamily: 'Space Grotesk, sans-serif', color: '#1a202c' }}>
            Let's Connect
          </h2>
          <p className="text-xl max-w-2xl mx-auto font-medium" style={{ color: '#2d3748' }}>
              ...
              <div className="relative bg-white/25 backdrop-blur-2xl border-2 border-white/40 rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] hover:shadow-[0_16px_48px_rgba(77,168,218,0.2)] transition-all duration-300">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-xs text-gray-500 uppercase tracking-wider font-extrabold mb-1">Email</div>
                    <div className="text-gray-800 font-bold truncate">hemantaregmi20@gmail.com</div>
                  </div>
                </div>
              </div>
            </motion.a>
            ...
            >
              ...
              <div className="relative bg-white/25 backdrop-blur-2xl border-2 border-white/40 rounded-3xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] hover:shadow-[0_16px_48px_rgba(77,168,218,0.2)] transition-all duration-300">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-xs text-gray-500 uppercase tracking-wider font-extrabold mb-1">Location</div>
            ...
            >
              ...
              >
                <div className="bg-white/40 backdrop-blur-2xl border-2 border-white/60 rounded-full px-4 py-1.5 shadow-[0_4px_16px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.95)]">
                  <span className="text-sm font-bold text-gray-800">GitHub</span>
                </div>
              </motion.div>
            </div>
          ...
          >
            ...
            <div className="relative bg-white/25 backdrop-blur-2xl border-2 border-white/40 rounded-3xl p-8 lg:p-10 shadow-[0_16px_48px_rgba(0,0,0,0.12),inset_0_1px_0_rgba(255,255,255,0.8)] overflow-hidden">
              ...
              <form className="relative z-10 space-y-6" onSubmit={(e) => e.preventDefault()}>
                <div>
                  <label htmlFor="name" className="block text-sm font-extrabold text-gray-700 mb-2">Name</label>
                  <input 
                    type="text" 
                    id="name" 
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-extrabold text-gray-700 mb-2">Email</label>
                  <input 
                    type="email" 
                    id="email" 
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-extrabold text-gray-700 mb-2">Message</label>
                  <textarea 
                    id="message" 
                    rows={4} 
      ...
      {/* Footer simple */}
      <div className="border-t border-gray-200 mt-24 pt-8 pb-8">
        <div className="max-w-6xl mx-auto px-4 text-center text-gray-600 font-bold text-sm">
          <p>© {new Date().getFullYear()} Hemanta Regmi. Designed & Built with React & Tailwind.</p>
        </div>
      </div>
    </section>
  );
